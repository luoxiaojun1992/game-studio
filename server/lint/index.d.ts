 ...
 * @returns lint 检查结果
 */
export declare function lintGameContent(htmlContent: string, context?: LintContext): Promise<LintResult>;
/**
 * Lint 检查运行时
 *
 * 管理已注册的检查器列表，支持：
...
export declare class LintRunner {
     ...
     */
    run(content: string, context?: LintContext): Promise<LintResult>;
}
/**
 ...
 * @returns lint 检查结果
 */
export declare function lintZipBuffer(zipBuffer: Buffer, context?: LintContext): Promise<LintResult>;
