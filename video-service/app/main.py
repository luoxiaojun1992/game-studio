"""
Video Service — FastAPI entry point.
...
from app.routers import video, file, project
...
app = FastAPI(
    title="Video Service",
    description="FFmpeg-based video processing micro-service for game-studio",
    version="1.0.0",
    lifespan=lifespan,
)
...
if __name__ == "__main__":
    ...
    port = int(os.getenv("VIDEO_SERVICE_PORT", "8084"))
